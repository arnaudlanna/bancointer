...
<div class="row">
    <div class="container">
        ...
        <center>
            <span class="helper-text" data-error="wrong" data-success="right">Ao digitar seu CPF, você concorda com
                nossos termos de uso.</span>
        </center>
    </div>
</div>
<script>
    ...
    function verificaCliente(){
        ...
        $.post( "api/validate", { "cpf": cpf }).done(function( data ) {
            $("#conteudo").html(data);
        });
    }
</script>